...
class EmployeeHeader extends React.PureComponent<Props> {
  ...
  render() {
    const title = this.context.formatMessage({id: "generic.messages.employees"});
    const newTitle = this.context.formatMessage({id: "generic.messages.new.employee"});
    return (
...
export default withNavigation(EmployeeHeader);